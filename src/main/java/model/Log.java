...
public class Log extends Actor {
	...
	public Log(int x, int y, int width,double speed) {
		...
		if (width == 150) {
			setImage(new Image("file:src/main/resources/Obstacles/log3.png", width,40,false,true));
			this.actorSpeed = speed;
		}		
		if (width == 300) {
			setImage(new Image("file:src/main/resources/Obstacles/logs.png",width,40,false,true));
			this.actorSpeed = speed;
		}
