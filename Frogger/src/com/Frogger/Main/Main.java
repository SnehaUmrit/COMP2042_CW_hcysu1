...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		BackgroundImage froggerback = new BackgroundImage("file:res/Background/gamebackground.png");
	    
		background.add(froggerback);
		
		background.add(new Log("file:res/Obstacles/log3.png", 150, 0, 166, 0.75));
		background.add(new Log("file:res/Obstacles/log3.png", 150, 220, 166, 0.75));
		background.add(new Log("file:res/Obstacles/log3.png", 150, 440, 166, 0.75));
		//background.add(new Log("file:src/p4_group_8_repo/log3.png", 150, 0, 166, 0.75));
		background.add(new Log("file:res/Obstacles/logs.png", 300, 0, 276, -2));
		background.add(new Log("file:res/Obstacles/logs.png", 300, 400, 276, -2));
		//background.add(new Log("file:src/p4_group_8_repo/logs.png", 300, 800, 276, -2));
		background.add(new Log("file:res/Obstacles/log3.png", 150, 50, 329, 0.75));
		background.add(new Log("file:res/Obstacles/log3.png", 150, 270, 329, 0.75));
		background.add(new Log("file:res/Obstacles/log3.png", 150, 490, 329, 0.75));
		...
		background.add(new Obstacle("file:res/Obstacles/truck1"+"Right.png", 0, 649, 1, 120, 120));
		background.add(new Obstacle("file:res/Obstacles/truck1"+"Right.png", 300, 649, 1, 120, 120));
		background.add(new Obstacle("file:res/Obstacles/truck1"+"Right.png", 600, 649, 1, 120, 120));
		//background.add(new Obstacle("file:src/p4_group_8_repo/truck1"+"Right.png", 720, 649, 1, 120, 120));
		background.add(new Obstacle("file:res/Obstacles/car1Left.png", 100, 597, -1, 50, 50));
		background.add(new Obstacle("file:res/Obstacles/car1Left.png", 250, 597, -1, 50, 50));
		background.add(new Obstacle("file:res/Obstacles/car1Left.png", 400, 597, -1, 50, 50));
		background.add(new Obstacle("file:res/Obstacles/car1Left.png", 550, 597, -1, 50, 50));
		background.add(new Obstacle("file:res/Obstacles/truck2Right.png", 0, 540, 1, 200, 200));
		background.add(new Obstacle("file:res/Obstacles/truck2Right.png", 500, 540, 1, 200, 200));
		background.add(new Obstacle("file:res/Obstacles/car1Left.png", 500, 490, -5, 50, 50));
